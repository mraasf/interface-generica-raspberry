    ...
    while True:
        ...
        if hora_atual == hora_final:
            ...
            with open("exit.csv", "a") as csvfile:
                ...
                ExitFile.writerow([identificacao_soinho,opcao,caixa.getLeftLeverResponse(),data_hora_inicial,alavanca_ativa,caixa.getRightLeverResponse(),data_hora_final,acertos,erros]) # escreve as strings de saida no csv
            caixa.stopSession()
            caixa.rightPalet = 0
            caixa.leftPalet = 0
