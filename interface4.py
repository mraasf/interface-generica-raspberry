...
#GPIO.setup(22, GPIO.IN)#nosePoke

#Estado inicial das saidas
estado_1 = False
estado_2 = False
estado_3 = False
estado_4 = False
...
def createDisplay():
  ...
  #Desenha Botao4  
  obj1Id = canvas.create_rectangle(5,5,628,155,fill=BLACK, tags = "objt1Tag")
  obj2Id = canvas.create_text( 80, 80,  text="Lamp Esquerda", fill="white", font=("Helvetica", 20, "bold"))
 
  canvas.tag_bind(obj1Id, '<ButtonPress-1>', onObjectClick4)
  canvas.tag_bind(obj2Id, '<ButtonPress-1>', onObjectClick4)
 
  #Desenha Botao2
  obj3Id = canvas.create_rectangle(162, 5, 783, 155,fill=BRIGHTBLUE,tags = "objt3Tag")
  obj4Id = canvas.create_text(236, 80,  text="alimento", fill="white", font=("Helvetica", 20, "bold"))
   
  canvas.tag_bind(obj3Id, '<ButtonPress-1>', onObjectClick5)
  canvas.tag_bind(obj4Id, '<ButtonPress-1>', onObjectClick5)
 
  #Desenha Botao3
  obj5Id = canvas.create_rectangle(319, 5, 975,155,fill=BLACK,tags = "objt5Tag")
  obj6Id = canvas.create_text(396, 80,  text="Lamp Direita", fill="white", font=("Helvetica", 20, "bold"))
   
  canvas.tag_bind(obj5Id, '<ButtonPress-1>', onObjectClick6)
  canvas.tag_bind(obj6Id, '<ButtonPress-1>', onObjectClick6)
...
def checkPort():
    #Verifica se a paleta direita foi ativada
    if GPIO.input(16) == 0:
        #Cria retangulo em amarelo e exibe mensagem
        canvas.create_rectangle(10,165, 468, 270,fill=YELLOW)
        canvas.create_text(240, 220, 468, 270, text=" Direita ATIVADA", fill="BLACK", font=("Arial", 70, "bold"))
    if GPIO.input(16) == 1:
        #Cria retangulo branco
        canvas.create_rectangle(5,160, 473, 275,fill=WHITE)
        canvas.create_text(240, 220, 473, 275, text="Direita DESATIVADA", fill='#E5E4E2', font=("Arial", 50, "bold"))
    tk.after(200,checkPort)
    
    #Verifica se a paleta esquerda foi ativada
    if GPIO.input(18) == 0:
        #Cria retangulo em amarelo e exibe mensagem
        canvas.create_rectangle(10,165, 980, 468,fill=YELLOW)
        canvas.create_text(440, 220,  980, 473, text=" esquerda ATIVADA", fill="BLACK", font=("Arial", 70, "bold"))
    if GPIO.input(18) == 1:
        #Cria retangulo branco
        canvas.create_rectangle(5,160, 980, 473,fill=WHITE)
        canvas.create_text(240, 220, 980, 473,  text="esquerda DESATIVADA", fill='#E5E4E2', font=("Arial", 50, "bold"))
    tk.after(200,checkPort)
